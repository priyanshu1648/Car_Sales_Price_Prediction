  ...
  return (
    <div className="h-[400px] w-full">
      ...
      <div className="mt-4 text-sm text-muted-foreground">
        <p>Feature importance shows the relative contribution of each feature to the prediction model.</p>
        <p>Car age is the most important feature, accounting for 28% of the model's predictive power.</p>
      </div>
    </div>
  )
}
